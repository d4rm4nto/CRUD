        ...
        <form action="<?= base_url('matakuliah/cetak'); ?>" method="POST">
            <table>
                ...
                <tr>
                    ...
                    <th>:</th>
                    <td>
                        <input type="text" name="nama" id="nama" value="<?= set_value('kode'); ?>" placeholder="Required">
                    </td>
        ...
        <table border="1pt">
            ...
            <?php foreach ($matkul as $matkul) : ?>
                <tr>
                    ...
                    <td><?= $matkul->nama; ?></td>
                    <td><?= $matkul->sks; ?></td>
                    <td><a href="<?= base_url('Matakuliah/edit/' . $matkul->kode) ?>">Edit</a></td>
                    <td><a href="<?= base_url('Matakuliah/hapus/' . $matkul->kode) ?>">Hapus</a></td>
                </tr>
            <?php endforeach; ?>
        </table>
    </center>
